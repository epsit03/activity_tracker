...
<head>
    ...
    <style>
        ...
        .hologram {
            ...
            width: 5.9rem; /* Adjust the width as needed */
            height: 5.9rem; /* Adjust the height as needed */
            background-size: 400%;
            float: right;
            /* border-radius: 10px; */
            margin-left: auto;
...
<body>
    <div class="card">
        ...
        <div>
        <span class="emboss" style="font-size: 13px;"><?php echo $memberDetails['address']; ?></span>
        <span class="emboss" style="font-size: 13px;"><?php echo $memberDetails['postcode']; ?></span>
